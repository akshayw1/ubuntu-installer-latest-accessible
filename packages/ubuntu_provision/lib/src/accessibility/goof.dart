...
class AccessibilityPage extends ConsumerWidget with ProvisioningPage {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    // Force screen reader to announce title when page loads
    WidgetsBinding.instance.addPostFrameCallback((_) {
      SemanticsService.announce(
        'Accessibility issn ${flavor.displayName}',
        TextDirection.ltr,
      );
    });
    ...
    return HorizontalPage(
      ...
      children: [
        // ExcludeSemantics on the image to prevent it from being read first
        ExcludeSemantics(
          child: Container(height: 0),
        ),
        
        
        // Skip adding the explicit title text - keep just the body text
